...
class query:
    ...
    def __init__(self):
        ...
        self._injury_suffix='/friv/injuries.fcgi'
        return
    ...
    def team(self, team_cd,season_end_year):
        url = f'{self._base_url}/teams/{team_cd}/{season_end_year}.html'
        response = self.get_page(url)
        return response
    
    def regular_season_schedule(self, season_end_year,month_end_code):
        url = f'{self._base_url}/leagues/NBA_{season_end_year}_games-{month_end_code}.html'
        response = self.get_page(url)
        return response
    
    def boxscores(self, suffix):
    ...
    def injury(self):
        ...
        url= f'{self._base_url}{self._injury_suffix}'
        response = self.get_page(url)
        return response
