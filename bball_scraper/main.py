...
from bball_scraper.read_tables import get_tables, get_boxscores
from bball_scraper.query import query
from datetime import datetime
from bs4 import BeautifulSoup as bs4
import pandas as pd

class DataBuilder(query):
    
    def __init__(self,data_store_path='',output_format='csv'):
        query.__init__(self)
